...
\numberwithin{equation}{section}
\item The {\em Kronecker delta} function is defined as 
\begin{align}
\delta(n) =
\begin{cases}
1 & n = 0
...
\begin{align}
	...
	\label{eq:10-pingala}
\end{align}
\item $\alpha, \beta$ are the roots of the equation 
\begin{align}
	z^2-z-1 = 0
\end{align}
\item 
...
\item Show that
\begin{align}
	X^{+}(z) = \frac{1}{1-z^{-1}-z^{-2}} \quad \abs{z} > \alpha
\end{align}
\item Show that 
\begin{align}
...
\end{align}
\item Show that 
%	\eqref{eq:10-orig-diff}
%	can be expressed as 
\begin{align}
	Y^{+}(z) = \frac{1+2z^{-1}}{1-z^{-1}-z^{-2}} \quad \abs{z} > \alpha
	\label{eq:10-Y+}
\end{align}
...
%	y(n)	 &= b(n+1), \quad  n \ge 0
%	\label{eq:10-orig-diff-rev-cond}
%\end{align}
%\item Show that the one sided Z transform of $x(n-1)$ and  $x(n+1)$  are 
%\begin{align}
%	 x(-1) + z^{-1}X^{+}(z) 
%\end{align}
%and
...
% \item Show that 
%\begin{align}
%	\sum_{k=1}^{\infty}\frac{a_k}{10^k} = \frac{1}{10}\sum_{k=0}^{\infty}\frac{x(k)}{10^k} 
%\end{align}
%%
%\item Show that 
%\begin{align}
...
% \item Show that 
%\begin{align}
%	\sum_{k=1}^{\infty}\frac{b_k}{10^k} =\frac{1}{10}	\sum_{k=1}^{\infty}\frac{y(k)}{10^k}  
%\end{align}
%\item Show that 
%\begin{align}
